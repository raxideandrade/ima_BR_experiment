...
if event == 1
    DrawFormattedText(win.window, ['Select the dominant image and focus on imagining the dominant image' ...
...
elseif event == 2
     DrawFormattedText(win.window, ['Select the dominant image and try to imagine the non-dominant image' ...
        '\n\n Left arrow = Brandenburg Tor Down arrow =Mixed  Right arrow = Angela Merkel' ...
        '\n\n Fixate on the fixation cross during the whole experiment' ...
        '\n\n\nPress the space bar to start'], 'center', 'center', [255 255 255], [], [], [], [], [], instructionRect);
elseif event == 3
    DrawFormattedText(win.window, ['Select the dominant image and abstain from imagining anything' ...
        '\n\n Left arrow = Brandenburg Tor Down arrow =Mixed  Right arrow = Angela Merkel' ...
        '\n\n Fixate on the fixation cross during the whole experiment' ...
        '\n\n\nPress the space bar to start'], 'center', 'center', [255 255 255], [], [], [], [], [], instructionRect);
elseif event == 4
